...
def main(chatbox, api_endpoint, credentials, verbose,
    ...
    with SampleAssistant(conversation_stream,
                         grpc_channel, grpc_deadline, chatbox) as assistant:
...
class GA_wrapper(Thread):
    def __init__(self):
        pass

    def add_chatbox(self, chatbox):
        self.chatbox = chatbox
